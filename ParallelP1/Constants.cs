namespace Parallel1
{
    public static class Constants
    {
        ...
        public const int FactorySulfurSeed = 3;

        public const int BaseSorcererSeed = 100;
        public const int BaseWarlockSeed = 200;

        public const int AlchemistSpawnerSeed = 300;
    }
}
